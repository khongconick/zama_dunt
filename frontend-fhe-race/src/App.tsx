          ...
          <div className="header-top-row">
            ...
            <div className="wallet-connection-top">
              <div className="wallet-toolbar">
                ...
                {/* ETH Balance */}
                {connected && (
                  <div className="eth-balance-display">
                    <span>{ethWalletBalance ? Number(ethWalletBalance).toFixed(2) : "0.00"} ETH</span>
                  </div>
                )}

                {/* Wallet Display */}
                {connected ? (
                  <div className="wallet-display-modern">
                    <div 
                    ...
                    {showDisconnectPopup && (
                      <div className="disconnect-popup-modern">
    ...
    <div style={{ textAlign: "center" }}>
     ...
     <div style={{ textAlign: "center" }}>
      ...
      <div className="footer">
        <p>
          Created by{" "}
          <a href="https://x.com/Huytran23994" target="_blank" rel="noreferrer">
            @Huytran23994
          </a>
        </p>
      </div>
